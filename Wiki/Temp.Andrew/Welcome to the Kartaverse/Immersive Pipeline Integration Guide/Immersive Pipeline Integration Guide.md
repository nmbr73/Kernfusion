...
\<p\>\<a href="Load://Comp:/sidecar\_demo\_end.comp"\>Load a .comp\</a\>\</p\>

\<p\>\<a href="Load://Reactor:/Deploy/Comps/Templates/UT\_Anonymous\_Water.comp"\>Load a .comp\</a\>\</p\>
...
\<p\>\<a href="AddMedia://Reactor:/Deploy/Macros/KartaVR/Images/latlong\_wide\_ar.jpg"\>Add an image\</a\>\</p\>

Run a script:

\<p\>\<a href="RunScript://Reactor:/Deploy/Scripts/Comp/hos\_SplitEXR\_Ultra.lua"\>Split the selected EXR image\</a\>\</p\>
...
\<p\>\<a href="DoAction://App\_CustomizeHotkeys"\>Run the Customize Hotkeys Action\</a\>\</p\>
...
If you are on a Linux system, system wide environment variables are typically defined by editing either a "$HOME/.profile" or "$HOME/.bash\_profile" document based upon your current shell.

You would then add new environment variable to the profile document that look a bit like this:

export REACTOR\_DEBUG\_FILES=true

export REACTOR\_DEBUG=true

export REACTOR\_INSTALL\_PATHMAP=AllData:
...
Here is an example of a Launch Agent PLIST text file that ships with the Reactor package manager. It is named "setenv.reactor.REACTOR\_DEBUG.plist" and is used to turn on debug logging via a "REACTOR\_DEBUG" environment variable that is set to a value of "true":
...
\<string\>setenv.reactor.REACTOR\_DEBUG\</string\>
...
\-rw-r--r--@  1 root  wheel   474 Nov 17 05:42 setenv.reactor.REACTOR\_BRANCH.plist

\-rw-r--r--@  1 root  wheel   463 Oct 25 07:25 setenv.reactor.REACTOR\_DEBUG.plist

\-rw-r--r--@  1 root  wheel   475 Oct 25 07:27 setenv.reactor.REACTOR\_DEBUG\_FILES.plist

\-rw-r--r--@  1 root  wheel   473 Dec  7 22:23 setenv.reactor.REACTOR\_INSTALL\_PATHMAP.plist
...
* LD\_LIBRARY\_PATH
* FUSION16\_PROFILE
* FUSION16\_PROFILE\_DIR
* FUSION16\_MasterPrefs
* FUSION\_LICENSE\_SERVER
* FUSION\_PLUGIN\_PATH
* FUSION\_OFX\_PLUGIN\_PATH
* OCIO
* LUA\_PATH
* LUA\_CPATH
* REACTOR\_DEBUG
...
C:\\Program Files\\Chaos Group\\V-Ray\\Maya 2023 for x64\\maya\_vray\\bin\\vray.exe
...
Description=If you use a proxy FusionRenderNode.exe, set this to the name of the renamed original.  For example, it might be set to FusionRenderNode\_original.exe.
...
HOU\_VERSIONS = ("9.0", "10.0", "11.0", "12.0", "13.0", "14.0", "15.0", "15.5", "16.0", "16.5", "17.0", "17.5", "18.0", "18.5", "19.0", "19.5")
...
\[Houdini19\_5\_Hython\_Executable\]
...
```json
This is meant to be Python code
In the Output
```
...
```
	...
	This is meant to be any code
	As a code block

Hier ist dann ein interner Link irgendwohin


Jetzt kommt ein Code Block:

	Und so weiter
	Un so fort

Und nun wieder normaler Text
...
"def\_prod\_key": "657L1",

"def\_prod\_ver": "2020.0.0.F",

"sel\_prod\_key": "657L1",

"sel\_prod\_ver": "2020.0.0.F",

"supported\_lic\_methods": \[
...
"def\_prod\_code": "MAYA",

"sel\_prod\_code": "MAYA"
...
At this point you should add "/opt/Autodesk/Adlm/R17/lib64/" directory temporarily to the "LD\_LIBRARY\_PATH" environment variables to set your shared libraries for this session.

For example, you can run the following command in a BASH shell:

export LD\_LIBRARY\_PATH=/opt/Autodesk/Adlm/R17/lib64/
...
sudo /opt/Autodesk/AdskLicensing/9.2.1.2399/helper/AdskLicensingInstHelper register -pk 657L1 -pv 2020.0.0.F -el EN\_US -cf /var/opt/Autodesk/Adlm/Maya2020/MayaConfig.pit
...
sudo ./vray\_adv\_52003\_maya2023\_centos7 -configFile="/home/vfx/config\_vray.xml" -ignoreErrors=1
...
export VRAY\_FOR\_MAYA2023\_MAIN=/usr/autodesk/maya2023/vray

export VRAY\_FOR\_MAYA2023\_PLUGINS=/usr/autodesk/maya2023/vray/vrayplugins

export VRAY\_OSL\_PATH\_MAYA2023=/usr/autodesk/Maya2023/opensl

export VRAY\_PATH=/usr/autodesk/maya2023/vray/bin

export VRAY\_SEND\_FEEDBACK=1

export VRAY\_TOOLS\_MAYA2023=/usr/autodesk/Maya2023/bin

Windows Standalone

VRAY\_FOR\_MAYA2023\_MAIN=C:\\Program Files\\Chaos Group\\V-Ray\\Standalone for x64\\vray

VRAY\_FOR\_MAYA2023\_PLUGINS=C:\\Program Files\\Chaos Group\\V-Ray\\Standalone for x64\\vray\\vrayplugins

VRAY\_OSL\_PATH\_MAYA2023=C:\\Program Files\\Chaos Group\\V-Ray\\Maya 2023 for x64/opensl

VRAY\_SEND\_FEEDBACK=1

VRAY\_TOOLS\_MAYA2023=C:\\Program Files\\Chaos Group\\V-Ray\\Maya 2023 for x64/bin

macOS Standalone

VRAY\_FOR\_MAYA2023\_MAIN=/Applications/Autodesk/maya2023/vray

VRAY\_FOR\_MAYA2023\_PLUGINS=/Applications/ChaosGroup/V-Ray/Maya2023/VRay.app/Contents/MacOS/plugins

VRAY\_OSL\_PATH\_MAYA2023=/Applications/ChaosGroup/V-Ray/Maya2023/opensl

VRAY\_PATH=/Applications/Autodesk/maya2023/vray/bin

VRAY\_SEND\_FEEDBACK=0

VRAY\_TOOLS\_MAYA2023=/Applications/ChaosGroup/V-Ray/Maya2023/bin
...
/usr/ChaosGroup/V-Ray/Maya2023-x64/bin/vraydr\_check -host=10.20.30.2 -port=20207
...
\[2021/Jul/8\|06:41:39\] \[2117 MB\] Successfully written image file "/Volumes/Projects/Yeti\_Vray\_Project/images/tmp/blue\_fur.exr"

When drag/drop importing a vrsene file grab the name from the fields:

img\_file="sphere.exr";

img\_dir="/Users/vfx/Documents/maya/projects/default/images/tmp/";
...
img\_file\_needFrameNumber=0;

img\_separateAlpha=0;

img\_noAlpha=0;

img\_dontSaveRgbChannel=0;
...
img\_rawFileSaveColorCorrections=0;
...
anim\_frame\_padding=4;

anim\_renumber\_on=0;

anim\_renumber\_start=0;

anim\_renumber\_step=1;

anim\_ren\_frame\_start=0;

frame\_start=1;

frames\_per\_second=1;
...
relements\_separateFolders=0;

relements\_separate\_rgba=0;
...
RenderMan-InstallerNCR-24.4.0\_2226589-osxMojave\_clang10.x86\_64.dmg
...
export RFM\_VERSION=24.4

export RFM\_MAYA\_VERSION=2023

export PIXAR\_LICENSE\_FILE=/Applications/Pixar/pixar.license
...
RFM\_MAYA\_VERSION=2023

PIXAR\_LICENSE\_FILE=C:\\Program Files\\Pixar\\pixar.license
...
"/Applications/Blackmagic Fusion 18/Fusion.app/Contents/MacOS/Fusion" -verbose -clean -log "$HOME/Desktop/Fusion\_log.txt"

On Windows, you can start Fusion Studio v18 from a command-prompt session using:

"C:\\Program Files\\Blackmagic Design\\Fusion 18\\Fusion.exe" /verbose /clean /log "%USERPROFILE%\\Desktop\\Fusion\_log.txt"
...
/Applications/Pixar/RenderManProServer-24.4/bin/prman "$HOME/Documents/Blackmagic Design/Fusion/test/ribs/test\_000.rib"
...
cd $HOME/Downloads/Houdini/houdini-19.5.303-linux\_x86\_64\_gcc9.3
...
./houdini\_setup\_bash

sudo chmod -R 777 /opt/hfs19.5

nano $HOME/.bash\_profile

\# User specific environment and startup programs

cd /opt/hfs19.5

source /opt/hfs19.5/houdini\_setup
...
sudo rm -rf /opt/sidefx\_packages/
...
Modify the HQROOT entries from your HQServer "network\_folders.ini" file's settings to a local dummy folder like:
...
\<ReconstructionRegion globalCoordinateSystem="+proj=geocent +ellps=WGS84 +no\_defs" globalCoordinateSystemName="local:1 - Euclidean"
...
Blackmagic\_Fairlight\_Sound\_Library\_Mac.dmg
...
Project Acoustics Figure: Connecting simulation to audio DSP with parameters[^fn1]
...
[![][image244]](https://www.youtube.com/watch?v=Fy9lQT_MJ3Q)
...
A logfile named "%TEMP%\\DxO\\DxO\_Output\_Log.txt" is written to disk. Make sure the folder named "%TEMP%\\DxO" exists in advance by creating the "DxO" sub-folder inside the temporary files folder using the Windows Command Prompt.
...
C:\\Users\\\<User name\>\\AppData\\Local\\DxO\\DxO.PhotoLab.exe\_StrongName\_addo3jomrfkt2faiwwfxxb444r1xfvlh\\3.2.0.4344\\user.config
...
Step 2. Use a MovieFileIn node to load an STMap template image named "Media/EOS\_R5C\_RF52\_STMap.0001.exr".
...
Click the "Browse" button and navigate on your hard disk to where this example project file is stored to select the STMap warping template image named: "STMap Canon R5C RF 5.2mm/Resolve Project/Media/EOS\_R5C\_RF52\_STMap.0001.exr".
...
![][image170]![][image348]![][image21]![][image34]
...
![][image67]![][image307]![][image36]

Quilted Frame

![][image28]

The image "Media/JPEGS/9x5\_quilted\_green\_lantern.jpg" holds 45 views of imagery in a 5 horizontal x 9 vertical image grid layout.
...
Reactor:/Deploy/Macros/KartaVR/Images/pikachu\_13x10\_image\_grid.jpg
...
Reactor:/Deploy/Macros/KartaVR/Images/lg\_silver\_mask\_4x4\_quilted.0001.jpg
...
Reactor:/Deploy/Macros/KartaVR/Images/lg\_green\_lantern\_5x9\_quilted.0001.jpg
...
"/Applications/Compressor.app/Contents/MacOS/Compressor" -batchname "ProRes Encode" -jobpath "$Home/Desktop/ImageSequence/" -settingpath "Reactor:/Deploy/Bin/compressor/settings/ProRes.cmprstng" -locationpath "$Home/Desktop/ProRes\_Encode.mov"
...
This code snippet assumes an environment variable named "SSHPASS\_DIR" exists that defines the sshpass installation location. It also uses the macOS based AVFoundation library to grab an image from a webcam named "Cisco VTCamera3".
...
"$SSHPASS\_DIR" -p 'correcthorsebatterystaple' ssh -n -t -t vfx@10.20.30.1  'opt/ffmpeg/bin/ffmpeg -y -f avfoundation -framerate 5.000000 -video\_size 1600x1200 -pixel\_format uyvy422 -vsync 2 -i "Cisco VTCamera3" -f image2 -vcodec mjpeg -vframes 1 -qscale:v 2 /Volumes/Media/screenshot.jpg'
...
PING\_ADDRESS\_DEFAULT\_FILE="$TMPDIR/ping\_address\_default.txt"

PING\_ADDRESS\_FILE="$TMPDIR/ping\_address.txt"

echo "www.cbc.ca" \> $PING\_ADDRESS\_DEFAULT\_FILE

\# open "$TMPDIR/"

\# bbedit $PING\_ADDRESS\_FILE

\# Where the output from the ping program is saved

PING\_RESULT\_FILE="$TMPDIR/ping\_result.txt"
...
--editbox "$PING\_ADDRESS\_DEFAULT\_FILE" 8 40 2\> "$PING\_ADDRESS\_FILE"

\# Save out the IP/Domain name to a textfile

PING\_ADDRESS\_URL\_STRING=\`cat "$PING\_ADDRESS\_FILE"\`

\# echo $PING\_ADDRESS\_URL\_STRING

\# Run the ping terminal program

ping -c 3 -i 0.5 $PING\_ADDRESS\_URL\_STRING \> "$PING\_RESULT\_FILE"

PING\_RESULT=\`cat "$PING\_RESULT\_FILE"\`
...
powershell -Command "& \{get-wmiobject -class Win32\_NetworkAdapterConfiguration -Filter IPEnabled=true \| select ipaddress\}"
...
\[HKEY\_CLASSES\_ROOT\\*\\shell\\Open with Notepad++\]

"Icon"="C:\\\\Program Files (x86)\\\\Notepad++\\\\notepad++.exe"

\[HKEY\_CLASSES\_ROOT\\*\\shell\\Open with Notepad++\\command\]
...
Here is an initial "$HOME/Library/Application Support/BBEdit/Preview CSS/DefaultCSS\_Markdown.css" file to get your development efforts underway:
...
LOVE\_PATH="/Applications/love.app/Contents/MacOS/love"

\# Base folder for the active document

BB\_DOC\_FOLDER="$(dirname $\{BB\_DOC\_PATH\})"

\# echo Opening Love Folder: $BB\_DOC\_FOLDER

  

\# Launch love with the parent folder for the active main.lua file

\# "$LOVE\_PATH" "$BB\_DOC\_FOLDER"

"$LOVE\_PATH" "$BB\_DOC\_FOLDER" \| BBEdit & 
...
MARKDOWN\_DOCUMENT="$\{BB\_DOC\_PATH\}"

  

\# Define the output filename

\# HTML\_OUTPUT="$\{MARKDOWN\_DOCUMENT\}.html"

HTML\_OUTPUT=\`echo "$\{MARKDOWN\_DOCUMENT\}" \| sed "s/\\..\*$//"\`".html"
...
MARKDOWN\_CSS="$HOME/Library/Application Support/BBEdit/Preview CSS/DefaultCSS\_Markdown.css"

MARKDOWN\_HTML\_HEADER="$HOME/Markdown/markdown\_header.html"

MARKDOWN\_HTML\_BODY="$HOME/Markdown/markdown\_body.html"

MARKDOWN\_HTML\_FOOTER="$HOME/Markdown/Markdown\_footer.html"
...
cat "$\{MARKDOWN\_HTML\_HEADER\}" \> "$\{HTML\_OUTPUT\}"

  

\# Append the CSS

cat "$\{MARKDOWN\_CSS\}" \>\> "$\{HTML\_OUTPUT\}"

  

\# Add the HTML body tag to the new file

cat "$\{MARKDOWN\_HTML\_BODY\}" \>\> "$\{HTML\_OUTPUT\}"

  

\# Append the Markdown converted text using the cmark command-line tool

/usr/local/bin/cmark "$\{MARKDOWN\_DOCUMENT\}" --to html \>\> "$\{HTML\_OUTPUT\}"

  

\# Append the HTML footer

cat "$\{MARKDOWN\_HTML\_FOOTER\}" \>\> "$\{HTML\_OUTPUT\}"
...
\# bbedit --language HTML "$\{HTML\_OUTPUT\}"
...
DefaultCSS\_Markdown.css File Location:

$HOME/Library/Application Support/BBEdit/Preview CSS/DefaultCSS\_Markdown.css

markdown\_header.html File Contents:
...
markdown\_body.html File Contents:
...
markdown\_footer.html File Contents:
...
A BBEdit shell script is able to access several handy environment variables. This feature lets your external script know things about the current document that is open "$\{BB\_DOC\_PATH\}", and what line is selected in the file "$\{BB\_DOC\_SELSTART\_LINE\}".

Here is list of the most common environment variables you can use with BBEdit launched shell scripts:

$\{BB\_DOC\_LANGUAGE\}        Name of the document's current language (not set if language is "none") BB\_DOC\_MODE            Emacs mode of the document's current language 

$\{BB\_DOC\_NAME\}            name of the document 

$\{BB\_DOC\_PATH\}            path of the document (not set if doc is unsaved) 

$\{BB\_DOC\_SELEND\}          (zero-based) end of the selection range (not set if not text document) 

$\{BB\_DOC\_SELEND\_COLUMN\}   (one-based) de-tabbed column number of BB\_DOC\_SELEND 

$\{BB\_DOC\_SELEND\_LINE\}     (one-based) line number of BB\_DOC\_SELEND 

$\{BB\_DOC\_SELSTART\}        (zero-based) start of the selection range (not set if not text document) 

$\{BB\_DOC\_SELSTART\_COLUMN\} (one-based) de-tabbed column number of BB\_DOC\_SELSTART 

$\{BB\_DOC\_SELSTART\_LINE\}   (one-based) line number of BB\_DOC\_SELSTART
...
You may have to customize your macOS Terminal shell session's "LUA\_PATH" and "LUA\_CPATH" environment variables if you want Fusion to be able to use the Lua Rocks compiled libraries. 
...
Create a new environment variable to hold the API key. Our environment variable will be named "OPENAI\_API\_KEY" and the variable will hold the contents of the API Key you created in step 2.
...
"message": "Incorrect API key provided: YOUR\_API\_KEY. You can find your API key at https://beta.openai.com.",
...
"curl.exe" -v -H "Content-Type: application/json" -H "Authorization: Bearer %OPENAI\_API\_KEY%" -d "\{\\"prompt\\": \\"Blackmagic Design Control Panel, Fusion Reactor, Cooling Tank, Blue Glow Water\\", \\"n\\": 1, \\"size\\": \\"256x256\\"\}"  https://api.openai.com/v1/images/generations
...
The command line version of cURL is used to perform a JSON request with an authorization token. You need to have an OpenAI API Key stored in an environment variable named "OPENAI\_API\_KEY".
...
In order to use the "kdrDallE" macro you need to have the "Vonk Ultra" package installed from Reactor. You also need to register for an OpenAI API key to access the Dall-E API via the web. This API key should be added to an environment variable on your computer named "OPENAI\_API\_KEY".
...
![][image229]![][image347]![][image345]![][image284]![][image110]![][image323]
...
Here is an Imagemagick shell scripting example that creates a desktop wallpaper image that has a text caption rendered from a text file named "desktop\_caption.txt". The output is saved to an image named "Desktop.png":

\#!/usr/bin/env bash [ref2]
...
printf "$\{HOST\} / $\{IPADDRESS\}\\n$\{MACADDRESS\} $\{NETSPEED\}\\n$\{HARDDISK\}\\n$\{OSVERSION\}"\> $TMPDIR/desktop\_caption.txt
...
![image112.png](image112.png)![image249.png](image249.png)![image113.png](image113.png)
...
sudo rpm -Uvh $HOME/Downloads/VirtualBox-6.1-6.1.32\_149290\_el8-1.x86\_64.rpm
...
Then select the Windows 10 ISO image named "**Win10\_21H2\_English\_International\_x64.iso**".
...
From the VirtualBox Menu at the top of the Win10 VM window, uncheck the "**Devices \> Optical Drives \> Win10\_21H2\_EnglishInternational\_x64.iso**" menu item. 
...
wget https://us.download.nvidia.com/XFree86/Linux-x86\_64/460.73.01/NVIDIA-Linux-x86\_64-460.73.01.run
...
sudo sh ./NVIDIA-Linux-x86\_64-460.73.01.run
...
\# You can then disable nouveau driver by changing the configuration "/etc/default/grub" file. Add the entry "nouveau.modeset=0" to the line starting with GRUB\_CMDLINE\_LINUX. 
...
GRUB\_CMDLINE\_LINUX="rhgb quiet nouveau.modeset=0"

GRUB\_DISABLE\_RECOVERY="true"

\# You can optionally remove the "quiet" entry on "GRUB\_CMDLINE\_LINUX" to be able to see startup messages for issues like missing drive automounts.
...
\#        capabilities: vga\_controller bus\_master cap\_list
...
sudo yum install mesa-demos.x86\_64
...
\# Toggle the prefs for all GPUs connected: [ref3]
...
sudo yum install -y gparted nfs-utils exfat-utils.x86\_64 fuse-exfat.x86\_64 kmod-hfsplus.x86\_64 kmod-hfs.x86\_64
...
[image287]: image287.png width=204px height=85px

[image399]: image399.png width=205px height=85px

[image314]: image314.png width=261px height=248px

[image316]: image316.png width=259px height=243px

[image90]: image90.png width=413px height=102px

[image261]: image261.png width=82px height=101px

[image267]: image267.png width=453px height=148px

[image384]: image384.png width=453px height=154px

[image357]: image357.png width=407px height=212px

[image172]: image172.png width=421px height=161px

[image371]: image371.png width=451px height=241px

[image18]: image18.png width=452px height=203px

[image311]: image311.png width=222px height=215px

[image41]: image41.png width=377px height=114px

[image75]: image75.png width=451px height=176px

[image148]: image148.png width=452px height=344px

[image121]: image121.png width=451px height=323px

[image376]: image376.png width=66px height=23px

[image143]: image143.png width=451px height=71px

[image49]: image49.png width=173px height=122px

[image269]: image269.png width=452px height=487px

[image60]: image60.png width=452px height=109px

[image285]: image285.png width=319px height=330px

[image228]: image228.png width=452px height=24px

[image287-1]: image287.png width=454px height=190px

[image399-1]: image399.png width=454px height=190px

[image262]: image262.png width=456px height=131px

[image93]: image93.png width=359px height=516px

[image236]: image236.png width=222px height=278px

[image308]: image308.png width=229px height=272px

[image363]: image363.png width=235px height=451px

[image50]: image50.png width=451px height=109px

[image12]: image12.png width=452px height=156px

[image205]: image205.png width=449px height=223px

[image245]: image245.png

[image163]: image163.png width=452px height=179px

[image139]: image139.png width=285px height=83px

[image202]: image202.png width=451px height=256px

[image115]: image115.png width=215px height=164px

[image161]: image161.png width=305px height=199px

[image321]: image321.png width=315px height=226px

[image203]: image203.png width=185px height=173px

[image322]: image322.png width=305px height=243px

[image389]: image389.png width=450px height=50px

[image359]: image359.png width=194px height=212px

[image173]: image173.png width=182px height=380px

[image44]: image44.png width=183px height=357px

[image255]: image255.png width=452px height=225px

[image61]: image61.png width=451px height=624px

[image35]: image35.png width=451px height=300px

[image344]: image344.png width=452px height=378px

[image80]: image80.png width=451px height=165px

[image145]: image145.png width=451px height=206px

[image27]: image27.png width=452px height=242px

[image349]: image349.png width=451px height=611px

[image33]: image33.png width=452px height=277px

