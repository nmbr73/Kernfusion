...
See the [MultiButtonEmulation](MultiButtonEmulation.md) for a (bad) example how one could mimic a multi button's behaviour (showing that there still is some dedicated implementation behind the MultiButtonControl).